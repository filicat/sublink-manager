...
export const translations = {
  'zh-CN': {
    ...
    editLink: '编辑',
    deleteLink: '删除',
    confirmDeleteLink: '确定要删除此短链接记录吗？',
    updateShortLink: '更新短链接',
    updating: '更新中...',
    updateFailed: '更新失败',
    updateSuccess: '短链接更新成功！',
    editingLinkPrefix: '正在编辑:',
    editToken: '编辑令牌',
    editTokenCopied: '编辑令牌已复制',
    storeEditTokenHint: '请保存此令牌以在其他设备编辑此短链接',
    cancel: '取消',
    manualAddLink: '手动添加链接（从其他设备导入）',
    addLink: '添加',
    deleteFromServer: '从服务器删除',
    deleteSuccess: '短链接已从服务器删除。',
    deleteFailed: '删除失败',
    missingTokenOrCode: '请输入短码和编辑令牌。',
    manualShortCodePlaceholder: '短码',
    manualEditTokenPlaceholder: '编辑令牌',
  ...
  'en-US': {
    ...
    editLink: 'Edit',
    deleteLink: 'Delete',
    confirmDeleteLink: 'Delete this saved link?',
    updateShortLink: 'Update Short Link',
    updating: 'Updating...',
    updateFailed: 'Update failed',
    updateSuccess: 'Short link updated!',
    editingLinkPrefix: 'Editing:',
    editToken: 'Edit Token',
    editTokenCopied: 'Edit token copied',
    storeEditTokenHint: 'Save this token to edit this link from other devices',
    cancel: 'Cancel',
    manualAddLink: 'Add link manually (import from other device)',
    addLink: 'Add',
    deleteFromServer: 'Delete from server',
    deleteSuccess: 'Short link deleted from server.',
    deleteFailed: 'Delete failed',
    missingTokenOrCode: 'Please enter both short code and edit token.',
    manualShortCodePlaceholder: 'Short code',
    manualEditTokenPlaceholder: 'Edit token',
  ...
  'fa': {
    ...
    editLink: 'ویرایش',
    deleteLink: 'حذف',
    confirmDeleteLink: 'این لینک ذخیره شده حذف شود؟',
    updateShortLink: 'به‌روزرسانی لینک کوتاه',
    updating: 'در حال به‌روزرسانی...',
    updateFailed: 'به‌روزرسانی ناموفق بود',
    updateSuccess: 'لینک کوتاه به‌روز شد!',
    editingLinkPrefix: 'در حال ویرایش:',
    editToken: 'توکن ویرایش',
    editTokenCopied: 'توکن ویرایش کپی شد',
    storeEditTokenHint: 'این توکن را برای ویرایش از دستگاه‌های دیگر ذخیره کنید',
    cancel: 'انصراف',
    manualAddLink: 'افزودن دستی لینک (واردات از دستگاه دیگر)',
    addLink: 'افزودن',
    deleteFromServer: 'حذف از سرور',
    deleteSuccess: 'لینک کوتاه از سرور حذف شد.',
    deleteFailed: 'حذف ناموفق بود',
    missingTokenOrCode: 'لطفاً کد کوتاه و توکن ویرایش را وارد کنید.',
    manualShortCodePlaceholder: 'کد کوتاه',
    manualEditTokenPlaceholder: 'توکن ویرایش',
  ...
  'ru': {
    ...
    deleteLink: 'Удалить',
    confirmDeleteLink: 'Удалить эту сохраненную ссылку?',
    updateShortLink: 'Обновить ссылку',
    updating: 'Обновление...',
    updateFailed: 'Не удалось обновить',
    updateSuccess: 'Ссылка обновлена!',
    editingLinkPrefix: 'Редактируется:',
    editToken: 'Токен редактирования',
    editTokenCopied: 'Токен скопирован',
    storeEditTokenHint: 'Сохраните этот токен для редактирования с других устройств',
    cancel: 'Отмена',
    manualAddLink: 'Добавить ссылку вручную (импорт с другого устройства)',
    addLink: 'Добавить',
    deleteFromServer: 'Удалить с сервера',
    deleteSuccess: 'Ссылка удалена с сервера.',
    deleteFailed: 'Не удалось удалить',
    missingTokenOrCode: 'Введите короткий код и токен редактирования.',
    manualShortCodePlaceholder: 'Короткий код',
    manualEditTokenPlaceholder: 'Токен редактирования',
